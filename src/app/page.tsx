...
export default function Home() {
  return (
    <BaseLayout
      bypassTopMargin={true}
      className="max-w-full items-center justify-center gap-8 p-0 text-center">
      <div className="fixed top-0 -z-20 h-full w-full bg-black/50" />
      <div className="group relative h-[356px] w-full overflow-hidden bg-black">
        <video
          autoPlay
          loop
          muted
        ...
        />
        <div className="relative z-10 flex h-full w-full flex-col items-center justify-center pt-16 transition-(--transition-primary) group-hover:opacity-0">
